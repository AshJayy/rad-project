        ...
        <div className="flex flex-col gap-4 mb-5 justify-between">
          <div className="flex-1 mb-5">
            <div className="flex flex-col gap-4">
              <Select value={formData.bank} disabled required>
                <option value="">Select Bank</option>
                <option value="1">Bank 1 - Operating systems</option>
                <option value="2">
                  Bank 2 - Data Structures and Algorithms
                </option>
              ...
              <div className="flex flex-col gap-3 mt-2">
                <Label htmlFor="question" value="Question Content" />
                <Textarea
                  id="question"
          ...
          <div className="mt-5">
            <Label htmlFor="justification" value="Justification" />
            <Textarea
              id="justification"
              placeholder="Type Here"
              required
